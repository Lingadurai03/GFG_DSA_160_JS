...
// Difficulty: EasyAccuracy: 65.2%Submissions: 171K+Points: 2Average Time: 20m
...
let root = [5, 4, 6, 3, null, null, 7, null, null, null, 8];
let n1 = 7;
let n2 = 8;
console.log(solution(createBSTFromArray(root), n1, n2));
