// Check for BST
// Difficulty: EasyAccuracy: 25.37%Submissions: 571K+Points: 2Average Time: 30m
...
function solution(root) {
  ...
  function isValid(root, minVal, maxVal) {
    ...
    return (
      isValid(root.left, minVal, root.data) &&
...
console.log(solution(createTreeFromArray([2, 1, 3, null, null, null, 5])));
