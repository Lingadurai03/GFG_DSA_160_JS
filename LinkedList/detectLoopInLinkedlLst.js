...
// Difficulty: MediumAccuracy: 43.49%Submissions: 474K+Points: 4Average Time: 20m
...
function solution(head) {
  ...
  while (temp && dummyTemp.next) {
    if (temp == dummyTemp) return true;
    temp = temp.next;
    dummyTemp = dummyTemp.next.next;
  }
  return false;
}

console.log(solution(createLinkedList([1, 3, 4, 5, 6])));
