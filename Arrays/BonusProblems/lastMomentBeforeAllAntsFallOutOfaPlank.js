...
// Difficulty: MediumAccuracy: 79.86%Submissions: 3K+Points: 4
...
function lastMomentBeforeAllAntsFallOutOfaPlank(left, right, n) {
  let res = 0;
...
console.log(lastMomentBeforeAllAntsFallOutOfaPlank([2], [0, 1, 3], 4));
